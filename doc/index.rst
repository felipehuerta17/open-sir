...
model <http://rocs.hu-berlin.de/corona/docs/forecast/model/#classic-sir-dynamics>`_
...
So far, Open-SIR provides an implementation of the SIR model and the novel `SIR-X model, developed by Maier and Dirk <https://science.sciencemag.org/content/early/2020/04/07/science.abb4557.full>`_ from the `Robert Koch Institut <http://rocs.hu-berlin.de/corona/docs/forecast/model/#sir-x-dynamics-outbreaks-with-temporally-increasing-interventions>`_
